...
CREATE UNIQUE INDEX X_MRDEF_PK ON MRDEF (ATUI);
...
CREATE UNIQUE INDEX X_MRRANK_PK ON MRRANK (SAB,TTY);
...
CREATE UNIQUE INDEX X_MRREL_PK ON MRREL (RUI);

CREATE INDEX X_MRREL_SAB ON MRREL(SAB);

CREATE UNIQUE INDEX X_MRSAB_PK ON (VSAB);
...
CREATE UNIQUE INDEX X_MRSAT_PK ON MRSAT (ATUI);
...
CREATE UNIQUE INDEX X_MRSTY_PK ON MRSTY (ATUI);
